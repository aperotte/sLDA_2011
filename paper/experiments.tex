...
\subfigure[][]{\label{fig:1b}\includegraphics[width=.49\textwidth]{figs/clin_pred_varying_mu}}
%\subfloat[][\label{fig:1c}]{\includegraphics[width=.49\textwidth]{figs/sens_comparison_leafs}}
\subfigure[][]{\label{fig:1d}\includegraphics[width=.49\textwidth]{figs/amazon_pred_varying_mu}}
\caption{Out-of-sample ICD-9 code prediction from patient free-text discharge records 
(\subref{1a} and \subref{fig:1b}). Out-of-sample Amazon product category predictions from 
product free-text descriptions (\subref{1c} and \subref{fig:1d}). In all figures, solid is 
...
auxiliary variable threshold and \subref{fig:1b} and \subref{fig:1d} show predictive perfmance as a function of the
