...
%\begin{figure}%[htbp]
%\begin{center}
%%\subfloat[][\label{1a}]{\includegraphics[width=.49\textwidth]{figs/amazon_pred_varying_mu}}
%\subfigure[][]{\label{1b}\includegraphics[width=.49\textwidth]{figs/clin_pred_varying_mu}}
%%\subfloat[][\label{1c}]{\includegraphics[width=.49\textwidth]{figs/sens_comparison_leafs}}
%\subfigure[][]{\label{1d}\includegraphics[width=.49\textwidth]{figs/amazon_pred_varying_mu}}
%\caption{Out-of-sample ICD-9 code prediction from patient free-text discharge records 
%(\subref{} and \subref{1b}). Out-of-sample Amazon product category predictions from 
%product free-text descriptions (\subref{} and \subref{1d}). In all figures, solid is 
...
%auxiliary variable threshold and \subref{1b} and \subref{1d} show predictive perfmance as a function of the
...
% \subfigure[]{
%   \fbox{\parbox{0.35\columnwidth}{\scriptsize
%       \textsf{TEMPLATE Id: 12.01\\
%         FILE No: ahj\_137\_02\_0424\\
%         SENTENCE No: S-98\\
%         RELATION: prediction\\
...
%         \mbox{~~~}ITEM: \\
%         \mbox{~~~~~~}CUI: C0155626\\
%         \mbox{~~~~~~}LEX: new acute myocardial infarction\\
%         PARAMETER(S):\\
%         \mbox{~~~}ITEM: \\
%         \mbox{~~~~~~}CUI: C0520887\\
%         \mbox{~~~~~~}LEX: ST-segment depression
%       }}}
% }\goodgap
% \subfigure[]{
%   \fbox{\parbox{0.35\columnwidth}{\scriptsize
%       \textsf{TEMPLATE Id: 12.02\\
%         FILE No: ahj\_137\_02\_0424\\
%         SENTENCE No: S-98\\
%         RELATION: prediction\\
%         ANALYSIS TYPE: independent\\
...
%         \mbox{~~~}ITEM: \\
%         \mbox{~~~~~~}CUI: C0002962\\
%         \mbox{~~~~~~}LEX: prior angina%
%       }}}
% }\\     \vspace*{-\subfigtopskip}
% \subfigure[]{
%   \fbox{\parbox{0.35\columnwidth}{\scriptsize
%       \textsf{TEMPLATE Id: 12.03\\
%         FILE No: ahj\_137\_02\_0424\\
%         SENTENCE No: S-98\\
%         RELATION: prediction\\
%         ANALYSIS TYPE: independent\\
...
%       }}}
% }}
%\caption{A Content Item after atomization.}\label{fig:org-afteratom}
%\end{figure}
