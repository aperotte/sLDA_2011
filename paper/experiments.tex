...
The following are the performance results for the clinical data given a prior
mean for the regression parameters of $\mu=-1.6$.  The full HSLDA model had a
true positive rate of 0.57  
