...
\begin{figure}[htbp]
\begin{center}
%\subfigure[][\label{1a}]{\includegraphics[width=.49\textwidth]{figs/amazon_pred_varying_mu}}
...
auxiliary variable threshold and \subref{1b} shows predictive perfmance as a function of the
...
\begin{center}
%\subfigure[][\label{1a}]{\includegraphics[width=.49\textwidth]{figs/amazon_pred_varying_mu}}
\subfigure[][\label{1b}]{\includegraphics[width=.49\textwidth]{figs/amazon_pred_varying_mu}}
%\subfigure[][\label{1c}]{\includegraphics[width=.49\textwidth]{figs/sens_comparison_leafs}}
%\subfigure[][\label{1d}]{\includegraphics[width=.49\textwidth]{figs/one_m_spec_comparison_leafs}}
