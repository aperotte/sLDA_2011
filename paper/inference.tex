...
\subsubsection{$p(\boldsymbol\eta_{l}\mid\mathbf{z},\mathbf{a},\sigma)$}
...
p\left(a_{l,d,}\mid\mathbf{z},\mathbf{Y},\mathbf{\boldsymbol\eta}\right)\propto\frac{1}{\sqrt{2\pi}}exp\left\{ -\frac{1}{2}\left(a_{l,d}-\boldsymbol\eta_{l}^{T}\mathbf{\bar{z}}_{d}\right)\right\} I\left(a_{l,d}y_{l,d}>0\right).\end{equation}
