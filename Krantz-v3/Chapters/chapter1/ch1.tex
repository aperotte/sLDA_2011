\chapterauthor{Frank Wood}{Columbia University, Department of Statistics, New York, NY 10027 USA}
\chapterauthor{Adler Perotte}{Columbia University, $\ldots$, New York, NY 10027}
...
\input{Chapters/chapter1/related_work}
...
\label{sec:model}
\input{Chapters/chapter1/model}

\section{Inference}
\label{sec:inference}
\input{Chapters/chapter1/inference}
...
\input{Chapters/chapter1/discussion}

\section{Appendix}
%\subsection{MCMC}
%\label{sec:mcmc}
%\input{Chapters/chapter1/mcmc}
%\subsection{Auxiliary Variables}
\subsection{Probit Regression}
\label{sec:probit_review}
\input{Chapters/chapter1/probit}
